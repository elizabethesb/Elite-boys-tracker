    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ fontSize: 13, fontWeight: 700, color: "#aaa", marginBottom: 16, letterSpacing: 1 }}>
          {isEdit ? "EDIT TASK" : `ADD ${type.toUpperCase()} TASK`}
        </div>
...
function PointLog({ log }) {
  if (!log.length) return (
    <div style={{ color: "#555", fontSize: 13, textAlign: "center", padding: "18px 0" }}>No activity yet</div>
  );
  return (
...
function TaskRow({ task, color, type, onAction, onEdit, onDelete }) {
  ...
  return (
    <div style={{ display: "flex", gap: 6, alignItems: "stretch" }}>
      ...
      {showActions && (
        <div style={{
          position: "absolute", right: 20, background: "#1e1e2e", border: "1px solid #333",
          borderRadius: 10, padding: 6, zIndex: 50, display: "flex", flexDirection: "column", gap: 4, minWidth: 110
        }}>
  ...
  return (
    <div style={{
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
        <div>
          <div style={{ fontSize: 11, letterSpacing: 3, color: boy.color, fontWeight: 700, textTransform: "uppercase" }}>
            Elite Boys Reward
          </div>
          <div style={{ fontSize: 26, fontWeight: 800, color: "#fff", letterSpacing: -1, marginTop: 2 }}>
            {boy.name}
          </div>
        </div>
  ...
  return (
    <div style={{
      ...
      <div style={{ textAlign: "center", marginBottom: 28 }}>
        ...
        <div style={{ fontSize: 12, color: "#444", marginTop: 4 }}>Points reset every 3 months · Only parents award points</div>
        <div style={{
